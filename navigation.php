    ...
    <div class="container">
        ...
        <ul>
            ...
            <?php if(isset($_SESSION['user_id'])): ?>
                <li><a href="add_products.php" style="background:#10b981;color:white;padding:0.5rem 1rem;border-radius:5px;text-decoration:none;font-weight:bold;">إدارة المنتجات</a></li>
